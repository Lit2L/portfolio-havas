...
import { GitBranchPlus, HomeIcon, NotebookIcon } from 'lucide-react'
	...
	certifications: [
		{
			...
			degree: 'Associate Data Engineer',
			logoUrl: '/dc.png',
			...
			links: [
				{
					type: 'Website',
					href: 'https://zillow.com',
					icon: <SiZillow className='size-3' />
				}
			],
			image: '',
			...
			links: [
				{
					type: 'Website',
					href: 'https://automatic.chat',
					icon: <IconGlobeOff className='size-3' />
				}
			],
			image: '',
	...
	hackathons: [
		...
		},
		{
			...
			links: [
				{
					title: 'Achievements',
					icon: <IconGlobeFilled className='h-4 w-4' />,
					href: 'https://zillow.com'
				}
			]
		},
		...
		},
		{
			...
			location: 'Orange, CA',
			description: 'Taught basic database management skills for tech program funded by Zillow.',
			icon: 'public',
			image: '/zillow.png',
			links: []
		},
		{
			...
			location: 'Houston, TX',
			description: 'Taught basic SQL and database management skills for school program.',
			icon: 'public',
